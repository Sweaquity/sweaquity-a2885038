...
interface RejectedApplicationsTableProps {
...
export const RejectedApplicationsTable = ({ 
  applications, 
  expandedApplications, 
  toggleApplicationExpanded, 
  handleStatusChange, 
  isUpdatingStatus 
}: RejectedApplicationsTableProps) => {
  return (
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <CollapsibleContent className="p-4 border-t">
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <p className="text-sm">{application.notes || "No reason provided"}</p>
              </div>
