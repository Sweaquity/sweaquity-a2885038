...
export const TaskList = ({ 
  ...
  // Safely calculate the currentTotalTaskEquity
  const currentTotalTaskEquity = Array.isArray(tasks) 
    ? tasks.reduce((sum, task) => sum + (task.equity_allocation || 0), 0)
    : 0;
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      {task.skill_requirements && task.skill_requirements.map((skillReq: any, index: number) => (
