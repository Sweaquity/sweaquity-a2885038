              ...
              {(provided) => (
                ...
                >
                  ...
                  {sortTickets(columnTickets).map((ticket, index) => {
                    const ticketType = ticket.type || ticket.ticket_type || 'task';
                    const typeText = ticket.isTaskTicket ? 'Task' : ticket.isProjectTicket ? 'Project' : 
                                    ticketType === 'task' ? 'Task' : 
                                    ticketType === 'ticket' ? 'Ticket' : 
                                    ticketType === 'beta-test' ? 'Beta Test' : ticketType;
