...
export const EquityProjectItem = ({ application, onApplicationUpdated, compact = false }: EquityProjectItemProps) => {
  ...
  // Check for application.accepted_jobs and set default values if undefined
