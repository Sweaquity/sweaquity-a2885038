...
Generated on 2025-07-26T20:41:37.837Z
...
## 🔗 Broken Links & Imports (4)

### broken_import
- **File**: src/components/ticket/TicketManagement.tsx
- **Message**: Broken import: "./TicketKanbanBoard" cannot be resolved
- **Import Path**: ./TicketKanbanBoard

### broken_import
- **File**: src/components/ticket/TicketManagement.tsx
- **Message**: Broken import: "./TicketGanttChart" cannot be resolved
- **Import Path**: ./TicketGanttChart

### broken_import
- **File**: src/components/ticket/TicketManagement.tsx
- **Message**: Broken import: "./TicketStatistics" cannot be resolved
- **Import Path**: ./TicketStatistics

### broken_import
- **File**: src/main.tsx
- **Message**: Broken import: "./App.tsx" cannot be resolved
- **Import Path**: ./App.tsx
...
- **Message**: File is quite large (710 lines) - consider breaking it down
- **Lines**: 710
...
### ApplicationCard
- **File**: src/components/business/applications/ApplicationCard.tsx
- **Message**: Component "ApplicationCard" appears to be unused
- **Size**: 9137 bytes (224 lines)
...
### CareerHistoryCard
- **File**: src/components/job-seeker/career/CareerHistoryCard.tsx
- **Message**: Component "CareerHistoryCard" appears to be unused
- **Size**: 1148 bytes (45 lines)

### EducationCard
- **File**: src/components/job-seeker/career/EducationCard.tsx
- **Message**: Component "EducationCard" appears to be unused
- **Size**: 1094 bytes (45 lines)

### ApplicationHeader
- **File**: src/components/job-seeker/dashboard/applications/ApplicationHeader.tsx
- **Message**: Component "ApplicationHeader" appears to be unused
- **Size**: 494 bytes (22 lines)
